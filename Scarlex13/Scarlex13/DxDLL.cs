...
namespace DxLibDLL
{
	public static class DX
	{
		...
		extern static int  dx_SetCameraPositionAndTargetAndUpVec_x86( VECTOR  Position, VECTOR  Target, VECTOR  Up);
		[DllImport("DxLib_x64.dll", EntryPoint="dx_SetCameraPositionAndTargetAndUpVec")]
		extern static int  dx_SetCameraPositionAndTargetAndUpVec_x64( VECTOR  Position, VECTOR  Target, VECTOR  Up);
		public static int  SetCameraPositionAndTargetAndUpVec( VECTOR  Position, VECTOR  Target, VECTOR  Up)
		{
			if( System.IntPtr.Size == 4 )
			{
				return dx_SetCameraPositionAndTargetAndUpVec_x86( Position , Target , Up );
			}
			else
			{
				return dx_SetCameraPositionAndTargetAndUpVec_x64( Position , Target , Up );
			}
		}
